package id.ac.poliban.mi.e020320079.roomwordssampledelete;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.e020320079.roomwordssampledelete.REPLY";
